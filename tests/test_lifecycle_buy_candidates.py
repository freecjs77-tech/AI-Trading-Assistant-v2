...
def test_template_renders_top5_empty_state_kr(tmp_path):
    """lifecycle_kr.html renders empty-state message when top5_count == 0."""
    import os
    from jinja2 import Environment, FileSystemLoader
    ...
    ctx = {
        ...
        "broken_table": [], "new_confirmed": [],
        "top5_candidates": [],
        "top5_count": 0, "top5_max": 5, "top5_threshold": 3.0,
    }
    html = tmpl.render(**ctx)
    assert "오늘의 매수 후보" in html
